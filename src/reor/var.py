...
def _linear_varx_EGLS_impl(Y, Z, R=None, r=None, W=None):
...
def linear_varx_leastsq(y, x=None, p=1, s=0, weights=None,
    ...
    B : array-like, shape (p,) or (p, n_features, n_external)
        Array containing the values of the external factor coefficients.
    """
    ...
    if x is not None:
        ...
        B0 = gamma_LS[parameter_index:parameter_index + stride]
        parameter_index += stride
    else:
        B = None
        B0 = None
